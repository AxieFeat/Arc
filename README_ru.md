...
- **arc-extensions**: Различные расширения движка
  - Аудио: Звуковой движок с реализацией на OpenAL
  - Дисплей: Виртуальные экраны
  - Шрифт: Движок для рендера шрифтов
  - Ввод: Движок ввода с реализацией на GLFW
  - Модель: Формат моделей LWAM
  - Профилировщик: Простой профайлер
...
- JDK 21 или выше
- Kotlin 1.9 или выше
- Графическая карта, совместимая с OpenGL/Vulkan
