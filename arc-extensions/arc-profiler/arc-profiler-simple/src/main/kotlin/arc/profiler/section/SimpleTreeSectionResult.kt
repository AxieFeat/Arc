...
internal class SimpleTreeSectionResult(
    ...
    override var child: MutableList<SimpleTreeSectionResult> = mutableListOf(),
) : TreeSectionResult {
    ...
    fun addResult(child: SimpleTreeSectionResult) {
        this.child.add(child)
    }

    fun getResult(child: String): SimpleTreeSectionResult? {
